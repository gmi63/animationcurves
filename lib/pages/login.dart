        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: RoundedButton(
                ...
                child: Text(
                  isLoginFormEnabled ? "Go Backward" : "Go Forward",
                  style: TextStyle(
...
class LoginBlobClipper extends CustomClipper<Path> {
  ...
  Path _collapsedClip(Size size) {
    ...
    path.cubicTo(
      234.91799999999998 * _xScaling,
      248.659 * _yScaling,
      272.87 * _xScaling,
      301.691 * _yScaling,
      328.61199999999997 * _xScaling,
      301.691 * _yScaling,
    );
    path.cubicTo(
      384.3539999999999 * _xScaling,
      301.691 * _yScaling,
      414 * _xScaling,
      201.977 * _yScaling,
      414 * _xScaling,
    ...
    path.cubicTo(
      414 * _xScaling,
      0 * _yScaling,
      2.1316282072803006e-14 * _xScaling,
      0 * _yScaling,
      2.1316282072803006e-14 * _xScaling,
      0 * _yScaling,
    );
