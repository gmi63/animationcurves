  ...
  Widget build(BuildContext context) {
    ...
    var raisedButton = RaisedButton(
      ...
      shape: RoundedRectangleBorder(
          borderRadius: new BorderRadius.circular(rounded)),
      onPressed: onPressed,
      child: _child,
      disabledColor: AppColors.white.shade200,
      disabledTextColor: AppColors.moldyGreen.shade600,
...
class AppColors {
  static final MaterialColor moldyGreen = createSwatch(
    255,
    91,
    53,
  );
  static final MaterialColor sunsetYellow = createSwatch(
    33,
    22,
    81,
  );
  static final MaterialColor white = createSwatch(
    255,
    255,
    255,
  );
...
MaterialColor createSwatch(int r, int g, int b) {
  ...
  return MaterialColor(Color.fromRGBO(r, g, b, 1).value, swatch);
}
